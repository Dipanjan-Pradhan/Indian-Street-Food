...
// Serve static files
app.use('/Supplier/static', express.static(path.join(__dirname, '../Supplier/static.html')));
app.use('/Vendor/LandPage', express.static(path.join(__dirname, '../Vendor/LandPage.html')));
app.use('/Vendor/SupplierInfo', express.static(path.join(__dirname, '../Vendor/SupplierInfo.html')));
...
function requireAuth(req, res, next) {
    if (req.session && req.session.user) {
        ...
        res.redirect('/Supplier/login.html');
    }
}
